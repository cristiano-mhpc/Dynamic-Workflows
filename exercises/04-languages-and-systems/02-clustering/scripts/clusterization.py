...
def main(args):
    ...
    model, outname, n_clusters, score, _ = clustering(
        data,
        args.clustering_technique,
        args.seed,
        args.outname,
        score_metric=args.score_metrics,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outname", help="Output name", type=str, default="cluster")
    parser.add_argument("--seed", help="Seed", type=str)
    parser.add_argument(
        "--score-metrics", help="Score metric to use", type=str, default="silhouette"
    )
